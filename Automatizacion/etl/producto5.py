...
url = "https://www.amazon.com/dp/B0DB1K2VX4?ref_=cm_sw_r_apin_ct_ET4TVJV9PZSERTYFTCXW_1&language=en_US&th=1"
headers = {
...
def scrape_and_store():
    ...
    while attempts < max_attempts:
        try:
            ...
            product_data = {
                "producto_id": 5,  # Identificador para el mismo producto
                "title": title,
                "rating": rating,
                "price": price,
                "url": url,

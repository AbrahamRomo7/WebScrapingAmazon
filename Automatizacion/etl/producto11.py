...
url = "https://www.amazon.com/Bedroom-Control-Changing-Festival-Decoration/dp/B0932M1666/143-3200881-3752903?pd_rd_w=Rus9d&content-id=amzn1.sym.31346ea4-6dbc-4ac4-b4f3-cbf5f8cab4b9&pf_rd_p=31346ea4-6dbc-4ac4-b4f3-cbf5f8cab4b9&pf_rd_r=Q095QEAXCV7SE9ESQ0KW&pd_rd_wg=FYziI&pd_rd_r=c9bddca2-ac14-43a3-8451-ede5cbdf8966&pd_rd_i=B0932M1666&th=1"
headers = {
...
def scrape_and_store():
    ...
    while attempts < max_attempts:
        try:
            ...
            product_data = {
                "producto_id": 11,  # Identificador para el mismo producto
                "title": title,
                "rating": rating,
                "price": price,
                "url": url,
